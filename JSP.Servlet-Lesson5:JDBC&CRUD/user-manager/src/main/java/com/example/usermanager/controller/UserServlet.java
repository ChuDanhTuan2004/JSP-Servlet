...
public class UserServlet extends HttpServlet {
    ...
    private void sortUsersByName(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        List<User> listUser = userDAO.findAllSortedByName();
    ...
    private void searchUser(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        String input_country = request.getParameter("input_country");
        List<User> listUser = userDAO.findByCountry(input_country);
        request.setAttribute("listUser",listUser);
        RequestDispatcher dispatcher = request.getRequestDispatcher("user/list.jsp");
        dispatcher.forward(request, response);
    }
